...
instacart %>%
  ...
  plot_ly(x = ~days_since_prior_order, y = ~order_count, type = "scatter", mode = "markers") %>% 
    layout(title = 'Relationship between number of items ordered and days since prior order ', xaxis = list(title = 'Days since prior order'), yaxis = list(title = 'Number of items per order'))
```
